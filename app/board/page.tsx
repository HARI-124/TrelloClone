      ...
      <Droppable droppableId='board' direction="horizontal" type="column"   >
        {
          (provider) =>
            ...
            >
              <Column id='0' index={0} todo='To-Do' items={todos}  ></Column>
              <Column id='1' index={1} todo='In-progress' items={inProgress}  ></Column>
              <Column id='2' index={2} todo='Done' items={done} ></Column>
